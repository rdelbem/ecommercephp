              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="woocommerce-billing-fields">
                    ...
                    >
                      <label class="" for="billing_cep_1"
                        >Cep <abbr title="required" class="required">*</abbr>
                      </label>
                      <input
                        type="text"
                    ...
                    <div class="row">
                      <div class="col-sm-9">
                        ...
                        >
                          ...
                          <input
                            type="text"
                            value="<?php echo htmlspecialchars( $address["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                      ...
                      <div class="col-sm-3">
                        <p
                          id="billing_number_1_field"
                          class="form-row form-row-wide number-field validate-required"
                        >
                          <label class="" for="billing_number_1"
                            >Número
                            <abbr title="required" class="required">*</abbr>
                          </label>
                          <input
                            type="text"
                            value="<?php echo htmlspecialchars( $address["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                            placeholder="Número"
                            id="billing_address_1"
                            name="desnumber"
                            class="input-text"
                    ...
                    >
                      <label class="" for="billing_district"
                        >Bairro <abbr title="required" class="required">*</abbr>
                      </label>
                      <input
                        type="text"
                    ...
                    >
                      <label class="" for="billing_city"
                        >Cidade <abbr title="required" class="required">*</abbr>
                      </label>
                      <input
                        type="text"
                    ...
                    <div class="clear"></div>
                    <h3 id="order_review_heading" style="margin-top: 30px">
                      Detalhes do Pedido
                    </h3>
                    <div id="order_review" style="position: relative">
                      <table class="shop_table">
                        ...
                        <tfoot>
                          <tr class="cart-subtotal">
                            ...
                            <td>
                              <span class="amount"
                                >R$<?php echo formatPrice($cart["vlsubtotal"]); ?></span
                              >
                            </td>
                          </tr>
                          <tr class="shipping">
                          ...
                          <tr class="order-total">
                            ...
                            <td>
                              <strong
                                ><span class="amount"
                                  >R$<?php echo formatPrice($cart["vltotal"]); ?></span
                                ></strong
                              >
                            </td>
                          </tr>
                      ...
                      >
                        ...
                        <label class="" for="method-pagseguro"
                          ><img
                            style="height: 64px"
                            src="/res/site/img/logo-pagseguro.png"
                        /></label>
                      </p>
                      <p
                        id="billing_state_field"
                      ...
                      >
                        ...
                        <label class="" for="method-paypal"
                          ><img
                            style="height: 64px"
                            src="/res/site/img/logo-paypal.png"
                        /></label>
                      </p>
                      <div id="payment">
